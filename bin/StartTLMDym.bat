...
echo openModel("%DymolaPath%\Modelica\Library\Modelica 3.2.1\package.mo"); >> %MOSFILE%
...
echo simulateModel(problem="%6", startTime=%2, stopTime=%3, numberOfIntervals=%INTERVALS%, tolerance=0.000001, resultFile = "dsres", method="dassl"); >> %MOSFILE%
